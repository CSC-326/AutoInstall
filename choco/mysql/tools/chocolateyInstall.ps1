...
$packageType = 'msi'
$silentArgs = '/passive'
$url = 'https://cdn.mysql.com/Downloads/MySQL-5.7/mysql-5.7.12-win32.zip'
$url64 = 'https://cdn.mysql.com/Downloads/MySQL-5.7/mysql-5.7.12-winx64.zip'
...
try {
  ...
  $mysqld = "$($installDirBin)\mysqld" 
  $args = "--defaults-file=$iniFileDest --initialize-insecure"
  #Write-Host $mysqld $args
  
  $pinfo = New-Object System.Diagnostics.ProcessStartInfo
  $pinfo.FileName = $mysqld
  ...
  #Start-Process -filepath $mysqld -ArgumentList $args -Wait -PassThru
  #--init-file=$toolsDir\nopassword.txt
  #Write-Host "mysql installed without root password."
} catch {
